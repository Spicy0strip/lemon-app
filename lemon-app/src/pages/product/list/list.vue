		...
		<view class="prodcut-list-wrap">
			<scroll-view scroll-y="true" class="scroll-Y" :style="'height:' + scrollviewHigh + 'px;'" lower-threshold="50"
			 @scrolltolower="scrolltolowerFunc">
				...
				<view class="list">
					<view class="item" v-for="(item, index) in products" :key="index" @click="gotoList(item.id)">
				...
				<!-- 没有记录 -->
				<view class="d-c-c p30" v-if="products.length==0 && !loading">
        ...
        computed:{
            ...
            loadingType(){
                if(this.loading){
                    ...
                    if(this.products.length!=0&&this.no_more){
                        return 2;
                    }else{
                        return 0;
                    }
